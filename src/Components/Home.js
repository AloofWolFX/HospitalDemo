...
export default class Home extends Component {
  ...
  search = () => {
    if (
      this.state.searchKey.toLowerCase() === "75080" ||
      this.state.searchKey.toLowerCase() === "richardson"
    ) {
        ...
        <div className="container">
          <div className="col-lg-12 col-md-12 col-12">
            ...
            <input
              ...
              placeholder='Search by zip code "75080" or city "Richardson"'
              onChange={this.setSearchZipCode}
            />
                ...
                return (
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p className="mb-0">
                        Distance: {this.computeDistance(clinic.lat, clinic.lng)}{" "}
                        miles
                      </p>
