...
export default class Register extends Component {
  ...
  checkIfEnableButton = () => {
    if (
      ...
      this.state.ifEmailFormat &&
      !this.state.ifEmailExist &&
      this.state.password.length &&
      this.state.ifStrongPassword &&
      this.state.repeatPassword.length &&
      this.state.ifPasswordMatch &&
      this.state.firstName.length &&
      this.state.lastName.length &&
      this.state.phone.length &&
      !this.state.ifPhoneExist
    ) {
        ...
        <div className="user-form-wrapper">
          <div className="container">
            <div className="user-form-one">
              ...
              {this.state.ifEmailExist && (
                <span className="error-msg error-msg-left">Email exists</span>
              )}
              {!this.state.ifEmailFormat && (
                <span className="error-msg error-msg-left">
                  Not valid email
                </span>
              )}
              ...
              {!this.state.ifStrongPassword && (
                <span className="error-msg error-msg-left">
                  Password need to be with minimum length 6
                </span>
              )}
              <div className="col-lg-12 col-md-12 col-12">
                <input
