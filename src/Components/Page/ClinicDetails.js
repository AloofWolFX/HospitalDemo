          ...
          <div className="container new-container">
            <div className="card">
              <div className="card-body">
                ...
                <p className="mb-0">
                  Address: {this.state.clinic.address}, {this.state.clinic.city}
                  , {this.state.clinic.state} {this.state.clinic.zipcode}
                </p>
              ...
              <div className="card-body">
                ...
                {this.state.clinic &&
                  this.state.clinic.availability &&
                  Object.entries(this.state.clinic.availability).map((day) => {
                    if (day[1].length > 0) {
                      return (
                        <li key={day[0]}>
                          {day[0]}: {day[1][0]} - {day[1][1]}
                        </li>
                      );
                    } else {
