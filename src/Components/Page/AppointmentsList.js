  ...
  fetchAppointments = () => {
    fetch(
      env.api +
        ...
        this.state.userLoggedIn._id.toString()
    )
      .then((res) => res.json())
      .then((data) => {
        let pastAppointment = [];
      ...
      customUI: ({ onClose }) => {
        return (
          <div className="custom-ui">
            ...
            <p>
              Are you sure to delete the appointment on{" "}
              {new Date(appointment.date).toLocaleDateString("en-US")}{" "}
              {appointment.time} at {appointment.clinicName}
            </p>
            <button
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <p>
                      You can check your appointment wait time and check-in up
                      to 1 hour prior to your appointment time when you arrive
                      at the clinic.
                    </p>
                    <p>
                      Once checked in, the clinic staff will be notified that
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <p>
                      Please provide feedback for your past appointments to get
                      gift card reward and help us improve.{" "}
                    </p>
                  </div>
                  <table className="table">
                    <thead>
